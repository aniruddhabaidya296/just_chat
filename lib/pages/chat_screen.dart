...
import 'package:just_chat/components/full_photo.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Widget buildSticker() {
    return SingleChildScrollView(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            border: Border(
                top: BorderSide(color: COLORS.greyExtraLight, width: 0.5)),
            color: Colors.white),
  ...
  Widget buildInput() {
    return Container(
            ...
            child: Container(
              child: TextField(
                ...
                decoration: InputDecoration.collapsed(
                  ...
                  hintStyle: TextStyle(color: COLORS.greyLight),
                ),
                focusNode: focusNode,
              ),
            ),
      ...
      decoration: BoxDecoration(
          border:
              Border(top: BorderSide(color: COLORS.greyExtraLight, width: 0.5)),
          color: Colors.white),
    );
  }
